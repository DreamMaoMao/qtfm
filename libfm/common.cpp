...
QPalette Common::darkTheme()
{
    ...
    palette.setColor(QPalette::WindowText,  QColor(181, 172, 152));
    palette.setColor(QPalette::Base, QColor(46,47,48));
    palette.setColor(QPalette::AlternateBase, QColor(64,66,68));
    //palette.setColor(QPalette::ToolTipBase,  QColor(181, 172, 152));
    //palette.setColor(QPalette::ToolTipText,  QColor(181, 172, 152));
    palette.setColor(QPalette::Link,  QColor(181, 172, 152));
    palette.setColor(QPalette::LinkVisited,  QColor(181, 172, 152));
    palette.setColor(QPalette::ToolTipText, Qt::black);
    palette.setColor(QPalette::Text,  QColor(181, 172, 152));
    palette.setColor(QPalette::Button, QColor(64,66,68));
    palette.setColor(QPalette::ButtonText,  QColor(181, 172, 152));
    palette.setColor(QPalette::BrightText, Qt::red);
    palette.setColor(QPalette::Highlight, QColor(192, 151, 113));
    palette.setColor(QPalette::HighlightedText,  QColor(12, 9, 0));
